...
class Auth with ChangeNotifier {
  ...
  Future<void> signup(String email, String password, String name, String dob,
      File image) async {
    return _authenticate(email, password, 'signUp',
        name: name, dob: dob, image: image);
  }
  ...
  Future<void> editUser(WidgetRef ref, String userId, String email,
      String password, String name, String dob, File image) async {
  ...
  Future<String> getUserId(String token) async {
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyBB_JJRuXI1-1BaTHTYcipDTy44cQps4QY');
    try {
      final response =
          await http.post(url, body: json.encode({'idToken': token}));
  ...
  Future<void> _authenticate(String email, String password, String urlSegment,
      {String? name, String? dob, File? image}) async {
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyBB_JJRuXI1-1BaTHTYcipDTy44cQps4QY');
